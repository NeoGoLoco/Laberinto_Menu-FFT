...
{
    // Instancia estática para que cualquier objeto pueda acceder sin referencias (Singleton)
    ...
    // Arreglo crudo de los 512 samples (frecuencias/nodos)
    ...
    void Update()
    {
        ...
        // ANALISIS DE FRECUENCIAS: Calculamos los promedios
